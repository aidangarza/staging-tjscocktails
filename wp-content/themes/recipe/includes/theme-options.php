            ...
            public function setSections() {
                ...
                $this->sections[] = array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            ...
                            'desc'        => __('Select recipes you wish present as featured', 'recipe'),
                        ),
                        array(
                            'id'          => 'featured_slider_rotate',
                            'type'        => 'text',
                            'title'       => __( 'Featured Slider Auto Rotate', 'recipe' ),
                            'desc'        => __('Input auto rotate speed in sm. Leave empty to disable', 'recipe'),
                        ),                        
                        //Tumblr Top Bar Link
                        array(
                            'id' => 'cooking-levels',
                ...
                **********************************************************************/
                ...
                $this->sections[] = array(
                    'title' => __('SEO', 'recipe') ,
                    'icon' => '',
                    'desc' => __('This is important part for search engines.', 'recipe'),
                    'fields' => array(  
                        // Keywords
                        array(
                            'id' => 'seo_keywords',
                            'type' => 'text',
                            'title' => __('Keywords', 'recipe') ,
                            'desc' => __('<br />Type here website keywords separated by comma. <small>(eg. lorem, ipsum, adiscipit)</small>.', 'recipe')
                        ) ,
                        ...
                        array(
                            'id' => 'seo_description',
                            'type' => 'textarea',
                            'title' => __('Description', 'recipe') ,
                            'desc' => __('<br />Type here website description.', 'recipe')
                        ) ,
                    )
                );
                ...
                **********************************************************************/
                ...
                $this->sections[] = array(
                    ...
                    'icon' => '',
                    'desc' => __('Messagin settings.', 'recipe'),
                    'fields' => array(
                        array(
                            'id' => 'inform_user',
                            'type' => 'select',
                        ...
                        array(
                            ...
                            'desc' => __('Type email address where the informations about new submit will arrivw.', 'recipe')
                        ),                        
                    )
                );
                ...
                $this->sections[] = array(
                    ...
                    'fields' => array(
                        array(
                            ...
                            'desc' => __('Input email where the messages should arive.', 'recipe'),
                        ),
                    )
                );
